...
*Wil je het zelf proberen (op eigen risico)? → [clawdbot/clawdbot](https://github.com/clawdbot/clawdbot)*

*Vragen over security setup? DM me op [Twitter/X](https://twitter.com/thomasansems).*
